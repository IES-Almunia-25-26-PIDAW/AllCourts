...
const managerController = {
    ...
    /**
     * Devuelve un manager por su ID de la tabla managers (no el user_id).
     *
     * Params: id
    ...
    /**
     * Devuelve el manager asociado a un user_id concreto.
     * Útil para obtener el perfil manager del usuario autenticado.
     *
     * Params: userId
    ...
    updateSubscription: async (req, res, next) => {
        try {
            const { subscription_active, subscription_start, subscription_end } =
                req.body;
