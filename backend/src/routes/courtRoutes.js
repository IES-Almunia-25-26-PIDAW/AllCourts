...
router.post("/", authMiddleware, roleMiddleware("manager"), requireActiveManagerSubscription, requireManagerOwnClubFromBody, courtController.create);
router.put("/:id", authMiddleware, roleMiddleware("manager"), requireManagerOwnCourt, courtController.update);
