...
router.post(
  ...
  body('password')
    ...
    .withMessage('La contraseña debe tener al menos 8 caracteres y como máximo 128'),
...
router.post(
  ...
  body('newPassword')
    ...
    .isLength({ min: 8, max: 128 })
    .withMessage('La nueva contraseña debe tener al menos 8 caracteres y como máximo 128'),
  handleValidation,
