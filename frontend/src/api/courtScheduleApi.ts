...
import type { CourtSchedule, CreateCourtScheduleDTO, UpdateCourtScheduleDTO } from '@/types/courtSchedule';
/**
 ...
 */
export async function getCourtSchedulesByCourtId(courtId: string | number): Promise<CourtSchedule[]> {
 ...
 */
export async function upsertCourtSchedule(dto: CreateCourtScheduleDTO): Promise<{ message: string }> {
 ...
 */
export async function updateCourtSchedule(id: number, dto: UpdateCourtScheduleDTO): Promise<{ message: string }> {
 ...
 */
export async function deleteCourtSchedulesByCourtId(courtId: number): Promise<{ message: string }> {
