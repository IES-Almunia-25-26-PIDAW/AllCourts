...
export default function ManagerPage() {
	...
	const [clubModal, setClubModal] = useState<{ open: boolean; club?: Club }>({
		open: false,
	});
				...
				<div>
					{manager ? (
						<div className={styles.headerActions}>
							<div
								className={`${styles.badge} ${manager.subscription_active ? styles.active : styles.inactive}`}
							>
								{manager.subscription_active
									? t("manager.subscription_active")
									: t("manager.subscription_inactive")}
							</div>
							<Link
								href="/subscription"
							...
							>
								{manager.subscription_active
									? t("manager.subscription_manage")
									: t("manager.subscription_activate")}
							</Link>
						</div>
					) : (
						<div className={styles.badge + " " + styles.inactive}>
							{t("manager.no_profile")}
						</div>
					)}
				</div>
			</div>
				...
				<>
					...
					<div className={styles.statsGrid}>
						<div className={styles.card}>
							<DashboardCard
								title={t("manager.stat_courts")}
								value={stats?.total_courts ?? 0}
							/>
						</div>
						<div className={styles.card}>
							<DashboardCard
								title={t("manager.stat_bookings")}
						...
						<div className={styles.card}>
							<DashboardCard
								...
								value={new Intl.NumberFormat(currencyLocale, {
									style: "currency",
									currency: "EUR",
					...
					<div className={styles.chartsGrid}>
						...
						<div
							className={`${styles.chartCard} ${styles.chartWide}`}
						>
							<div className={styles.chartHeader}>
					...
					<div className={styles.section}>
						<div className={styles.sectionHeader}>
							<span className={styles.sectionTitle}>
								{t("manager.clubs_title")}
							</span>
							{canCreateContent && (
								<button
									className={styles.btnPrimary}
									onClick={() => setClubModal({ open: true })}
									type="button"
								>
									{t("manager.clubs_new")}
								</button>
