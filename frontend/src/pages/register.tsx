...
/**
 * @page Register
 * Página de registro con selector de rol (jugador o club).
 * El formulario es el mismo independientemente del rol —
 * el rol seleccionado se enviará junto al resto de datos al hacer submit.
 *
 * State:
...
export default function Register() {
  ...
  // Controla qué tipo de cuenta se va a crear
    ...
    <div className={styles.container}>
      <div className={styles.registerCard}>
        ...
        <div className={styles.loginLink}>
          ...
          <Link href="/login">{t("register.login_link2")}</Link>
        </div>
      </div>
    </div>
  );
