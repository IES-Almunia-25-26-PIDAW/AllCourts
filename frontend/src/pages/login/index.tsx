      ...
      <div className={styles.loginCard}>
        ...
        {showResend && (
          <div className={styles.resendBlock}>
            <p className={styles.subtitle}>{t('resendVerification.prompt')}</p>
            ...
            <button type="button" className={styles.resendButton} disabled={resendLoading} onClick={handleResend}>
              {resendLoading ? '...' : t('resendVerification.btn')}
            </button>
            {resendStatus && <p className={styles.subtitle}>{resendStatus}</p>}
          </div>
        )}
