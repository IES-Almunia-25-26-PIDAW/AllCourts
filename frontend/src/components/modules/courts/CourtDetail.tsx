 ...
 * Cabecera visual de una pista con imagen, datos básicos y precios.
 *
 * @param court Pista a mostrar en detalle.
 */
		...
		<section className={styles.hero}>
			...
			<div className={styles.heroCopy}>
				...
				<p className={styles.meta}>
					{court.club_name
						? court.club_name
						: t("courts.club_name_fallback")}
					{court.city ? ` · ${court.city}` : ""}
				</p>

				<div className={styles.chips}>
					<span className={styles.chip}>
						{t("courts.surface_label")}:{" "}
						{surfaceLabels[court.surface_type]}
					</span>
					<span className={styles.chip}>
						{t("courts.location_label")}:{" "}
						{court.address || t("courts.location_fallback")}
					</span>
				</div>

				<p className={styles.description}>
					{court.description || t("clubs.no_description")}
				</p>

				<div className={styles.priceCard}>
					<h2 className={styles.priceTitle}>
						{t("courts.price_title")}
					</h2>
