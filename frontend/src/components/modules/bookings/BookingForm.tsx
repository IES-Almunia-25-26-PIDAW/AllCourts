 ...
 * Flujo de reserva rápida para una pista concreta.
 * Permite elegir fecha, duración y franja horaria antes de iniciar el pago.
 *
 * @param court Pista sobre la que se construye la reserva.
 */
		...
		<section className={styles.card}>
			<div className={styles.header}>
				...
				<div className={styles.priceTag}>
					{t("booking.from", { price: formatPrice(estimatedPrice) })}
				</div>
			</div>
			...
			<div className={styles.grid}>
				<div className={styles.bookingTopRow}>
					...
					<div className={styles.bookingControls}>
							...
							<div className={styles.controlHeader}>
								<div>
									...
									<p className={styles.controlHint}>
										{t("booking.duration_hint", {
											min: formatDurationMinutes(
												court.min_unit_min,
											),
										})}
									</p>
						...
						<div className={styles.controlCard}>
							...
							availableSlots.length > 0 ? (
								<div className={styles.slotPickerWrap}>
									...
									<div className={styles.slotPreviewRow}>
										<span
											className={styles.slotPreviewLabel}
										>
											{t("booking.summary.chosen_time")}
										</span>
										<strong
											className={styles.slotPreviewValue}
										>
											{selectedSlot
												? formatTimeRange(
							...
							availableSlots.length === 0 ? (
								<p className={styles.notice}>
									{t("booking.no_reservations_possible")}
								</p>
							) : null}
				...
				<div className={styles.summaryRow}>
					<div className={styles.summaryCard}>
						<p className={styles.summaryLabel}>
							{t("booking.summary.club")}
						</p>
						<p className={styles.summaryValue}>
							{court.club_name ??
								t("booking.summary.club_fallback")}
						</p>
					</div>
					<div className={styles.summaryCard}>
						<p className={styles.summaryLabel}>
				...
				{availabilityError ? (
					<p className={styles.errorText}>{availabilityError}</p>
				) : null}
