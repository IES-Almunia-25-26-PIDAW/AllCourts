...
/**
 * @component CourtFormModal
 * Modal para crear o editar una pista dentro del panel del manager.
 *
 * @param isOpen Controla si el modal está visible.
 * @param onClose Callback para cerrar el modal.
 * @param court Pista existente cuando se edita.
 * @param clubs Lista de clubs disponibles para asociar la pista.
 */
				...
				<div className={styles.modalHeader}>
					<div className={styles.modalHeaderInner}>
						<h2 className={styles.modalTitle}>
							{court
								? t("courts.form_edit_title")
								: t("courts.form_new_title")}
						</h2>
						<p className={styles.modalSubtitle}>
							{t("courts.form_subtitle") || ""}
						</p>
					</div>
					<button
					...
					>
						...
						<div className={styles.sectionGrid}>
							<div className={styles.field}>
								...
								>
									{Object.entries(sportLabels).map(
										([value, label]) => (
							...
							<div className={styles.field}>
								...
								<select
									...
									onChange={(event) =>
										setSurfaceType(
											event.target.value as SurfaceType,
										)
									}
								>
									{Object.entries(surfaceLabels).map(
										([value, label]) => (
											<option key={value} value={value}>
												{label}
											</option>
							...
							<div className={styles.field}>
								...
								>
									<option value="false">
										{t("courts.form_outdoor")}
									</option>
									<option value="true">
										{t("courts.form_indoor")}
									</option>
								</select>
							</div>
						</div>
						...
						<div className={styles.sectionGrid}>
							...
							<div className={styles.field}>
								...
								<input
									...
									value={price120}
									onChange={(event) =>
										setPrice120(event.target.value)
									}
									required
								/>
							</div>
