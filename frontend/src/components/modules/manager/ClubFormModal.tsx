...
/**
 * @component ClubFormModal
 * Modal para crear o editar un club desde el panel del manager.
 *
 * @param isOpen Controla si el modal está visible.
 * @param onClose Callback para cerrar el modal.
 * @param club Club existente cuando se edita.
 * @param managerId Identificador del manager asociado al alta.
 */
		...
		try {
			...
			const message =
				error instanceof Error
					? error.message
					: t("manager.club_form_error_save");
				...
				<div className={styles.modalHeader}>
					<div className={styles.modalHeaderInner}>
						<h2 className={styles.modalTitle}>
							{club
								? t("manager.club_form_edit_title")
								: t("manager.club_form_new_title")}
						</h2>
						<p className={styles.modalSubtitle}>
							{t("manager.club_form_subtitle") || ""}
						</p>
					</div>
					<button
				...
				<form onSubmit={handleSubmit} className={styles.form}>
					...
					<section className={styles.section}>
						<div className={styles.field}>
							...
							/>
							<div className={styles.helperText}>
								{t("manager.club_form_description_help") || ""}
							</div>
						</div>
					</section>
